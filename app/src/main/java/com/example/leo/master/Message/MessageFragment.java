...
public class MessageFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mg_rv.setAdapter(new mg_rv_adapter(chatrooms, getActivity()));
        return view;
    ...
    private class mg_rv_adapter extends RecyclerView.Adapter<mg_rv_adapter.mg_rv_viewholder> {
        ...
        public mg_rv_adapter(List<Chatroom> chatrooms, Context context) {
        ...
        public void onBindViewHolder(final mg_rv_viewholder viewholder, int position) {
            if (position == 0) {
                ...
                final Chatroom chatroom = chatrooms.get(position - 1);
...
//                viewholder.item_time.setText(chatroom.getTime());
//                viewholder.item_content.setText(chatroom.getContent());
